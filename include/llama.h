...
extern "C" {
    ...
    enum llama_ftype {
        ...
        // [graft: turbo] TurboQuant ftypes. Values 43/44 match TheTom fork exactly so that
        // existing turboquant gguf headers (ftype field == 43/44) decode to the right type.
