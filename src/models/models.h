...
struct llama_model_glm_dsa : public llama_model_base {
    ...
    // STAP3 nested graph types (glm-dsa.cpp is STAP3 source; defines ::graph and ::graph_mtp ctors).
    struct graph : public llm_graph_context {
        graph(const llama_model & model, const llm_graph_params & params);
    };
...
struct llama_model_mimo2 : public llama_model_base {
    ...
    // STAP3 nested graph_mtp (mimo2.cpp is STAP3 source; defines ::graph_mtp::graph_mtp ctor).
    struct graph_mtp : public llm_graph_context {
        graph_mtp(const llama_model & model, const llm_graph_params & params);
    };
